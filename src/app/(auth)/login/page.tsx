        ...
        {magicSent ? (
          ...
          <div className="bg-card border border-border rounded-2xl p-8">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-border bg-background hover:bg-accent transition-colors duration-200 mb-6"
            >
            ...
            <div className="flex items-center gap-2 mb-6">
              <button
                ...
                className={`flex-1 py-2 text-xs font-body font-bold tracking-wide uppercase rounded-lg transition-all ${
                  mode === "magic"
